...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="/dist/bootswatch/dist/<?= SiteSetting::getStaticSiteSetting('site_theme') ?>/bootstrap.min.css">
    ...
    <div class="container-fluid container-auth">
        <div class="panel panel-auth">
            <div class="panel-heading">
                <h2 id="title-container" class="panel-title text-center"><?= $this->e($title) ?>
                    - <?= SiteSetting::getStaticSiteSetting('site_name') ?></h2>
            ...
            <div class="panel-footer">
                <label>Hulp bij aanmelden
                    <div class="small">
                        <del>Registreren</del>
                        | <a href="/Login/Activate">Activeren</a> | <a href="/Login/RequestPasswordReset">Wachtwoord
                            vergeten</a></div>
                </label>
            </div>
        </div>
