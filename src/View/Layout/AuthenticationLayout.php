...
<head>
    ...
    <title><?= $this->e($title) ?> - <?= $this->e($siteName) ?></title>
    <link rel="stylesheet" type="text/css" href="/dist/@fortawesome/fontawesome-free/css/all.min.css">
    <link rel="stylesheet" type="text/css" href="/dist/bootswatch/dist/<?= $this->e($siteTheme) ?>/bootstrap.min.css">
...
<div class="container-fluid container-auth">
    <div class="auth-brand m-t-md m-b-md"><?= $this->e($siteName) ?></div>
</div>
<form method="post">
    <div class="container-fluid container-auth">
        <div class="panel panel-auth">
            <div class="panel-heading">
                <h2 id="title-container" class="panel-title text-center"><?= $this->e($title) ?> - <?= $this->e($siteName) ?></h2>
                <?php echo $this->insert('View::Partials/FlashMessages', compact('flashMessages')); ?>
            </div>
            <div class="panel-body"><?= $this->section('body') ?></div>
            <div class="panel-footer">
                <label>Hulp bij aanmelden</label>
                <div class="small"><del>Registreren</del> | <a href="/Login/Activate">Activeren</a> | <a href="/Login/RequestPasswordReset">Wachtwoord vergeten</a></div>
            </div>
        </div>
