...
<div class="form-group row">
    ...
    <div class="col-8">
        <input type="text" name="site_name" value="<?= SiteSetting::getStaticSiteSetting('site_name') ?>"
               class="form-control">
    </div>

    <label class="col-4 col-form-label"><?= Text::get('LABEL_SITE_DESC') ?></label>
    <div class="col-8">
        <input type="text" name="site_description" value="<?= SiteSetting::getStaticSiteSetting('site_description') ?>"
               class="form-control">
    </div>
    ...
    <div class="col-8">
        <input type="text" name="site_url" value="<?= SiteSetting::getStaticSiteSetting('site_url') ?>"
               class="form-control">
    </div>

    <label class="col-4 col-form-label"><?= Text::get('LABEL_SITE_LOGO_URL') ?></label>
    <div class="col-8">
        <input type="text" name="site_logo" value="<?= SiteSetting::getStaticSiteSetting('site_logo') ?>"
               class="form-control">
    </div>
...
<div class="form-group row">
    ...
    <div class="col-8">
        <input type="text" name="MailServer" value="<?= SiteSetting::getStaticSiteSetting('MailServer') ?>"
               class="form-control">
    </div>
    <label class="col-4 col-form-label">SMTP server port</label>
    <div class="col-8">
        <input type="text" name="MailServerPort" value="<?= SiteSetting::getStaticSiteSetting('MailServerPort') ?>"
               class="form-control">
    </div>
    ...
    <div class="col-8">
        <input type="text" name="MailServerUsername"
               value="<?= SiteSetting::getStaticSiteSetting('MailServerUsername') ?>" class="form-control">
    </div>
    <label class="col-4 col-form-label">SMTP password</label>
    <div class="col-8">
        <input type="password" name="MailServerPassword"
               value="<?= SiteSetting::getStaticSiteSetting('MailServerPassword') ?>" class="form-control">
    </div>
    ...
    <div class="col-8">
        <input type="text" name="MailFromName" value="<?= SiteSetting::getStaticSiteSetting('MailFromName') ?>"
               class="form-control">
    </div>

    <label class="col-4 col-form-label">MailFromEmail</label>
    <div class="col-8">
        <input type="text" name="MailFromEmail" value="<?= SiteSetting::getStaticSiteSetting('MailFromEmail') ?>"
               class="form-control">
    </div>
