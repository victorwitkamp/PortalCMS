...
<form method="post">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input minlength="1" maxlength="2" type="number" name="bandcode" class="form-control"  <?= ($pageType === 'edit' && !empty($contract->bandcode)) ? 'value="' . $contract->bandcode . '"' : '' ?> required>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="kosten_ruimte" class="form-control"  <?= ($pageType === 'edit' && !empty($contract->kosten_ruimte)) ? 'value="' . $contract->kosten_ruimte . '"' : '' ?>>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_kast" class="form-control"  <?= ($pageType === 'edit' && !empty($contract->kosten_kast)) ? 'value="' . $contract->kosten_kast . '"' : '' ?>>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_totaal" class="form-control" <?= ($pageType === 'edit' && !empty($contract->kosten_totaal)) ? 'value="' . $contract->kosten_totaal . '"' : '' ?> disabled>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_borg" class="form-control" <?= ($pageType === 'edit' && !empty($contract->kosten_borg)) ? 'value="' . $contract->kosten_borg . '"' : '' ?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="tel" name="bandleider_telefoonnummer1" class="form-control" <?= ($pageType === 'edit' && !empty($contract->bandleider_telefoonnummer1)) ? 'value="' . $contract->bandleider_telefoonnummer1 . '"' : '' ?>>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-phone"></i></div></div>
                            <input type="tel" name="bandleider_telefoonnummer2" class="form-control" <?= ($pageType === 'edit' && !empty($contract->bandleider_telefoonnummer2)) ? 'value="' . $contract->bandleider_telefoonnummer2 . '"' : '' ?>>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email"
                                   ...
                                   name="bandleider_email" class="form-control" <?= ($pageType === 'edit' && !empty($contract->bandleider_email)) ? 'value="' . $contract->bandleider_email . '"' : '' ?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="bandleider_bsn" class="form-control" <?= ($pageType === 'edit' && !empty($contract->bandleider_bsn)) ? 'value="' . $contract->bandleider_bsn . '"' : '' ?>>
                        </div>
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="huur_oefenruimte_nr" value="1" <?= ($pageType === 'edit' && !empty($contract->huur_oefenruimte_nr) && $contract->huur_oefenruimte_nr === '1') ? 'checked' : '' ?>>
                        <label class="form-check-label">Oefenruimte 1</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="huur_oefenruimte_nr" value="2" <?= ($pageType === 'edit' && !empty($contract->huur_oefenruimte_nr) && $contract->huur_oefenruimte_nr === '2') ? 'checked' : '' ?>>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="huur_kast_nr" class="form-control" <?= ($pageType === 'edit' && !empty($contract->huur_kast_nr)) ? 'value="' . $contract->huur_kast_nr . '"' : '' ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-append"><div class="input-group-text"><i class="far fa-clock"></i></div></div>
                        <input type="time" name="huur_start" class="form-control" <?= ($pageType === 'edit' && !empty($contract->huur_start)) ? 'value="' . $contract->huur_start . '"' : '' ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <div class="input-group-append"><div class="input-group-text"><i class="far fa-clock"></i></div></div>
                        <input type="time" name="huur_einde" class="form-control"<?= ($pageType === 'edit' && !empty($contract->huur_einde)) ? 'value="' . $contract->huur_einde . '"' : '' ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input type="text" name="beuk_vertegenwoordiger" class="form-control" <?= ($pageType === 'edit' && !empty($contract->beuk_vertegenwoordiger)) ? 'value="' . $contract->beuk_vertegenwoordiger . '"' : '' ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <hr>
            <p>* = verplicht veld.</p>
            <input type="hidden" name="id" <?= ($pageType === 'edit' && !empty($contract->id)) ? 'value="' . $contract->id . '"' : '' ?>>
            <input type="submit" <?= ($pageType === 'edit') ? 'name="updateContract"' : 'name="newContract"' ?> class="btn btn-sm btn-primary" value="Opslaan">
            <a <?= ($pageType === 'edit' && !empty($contract->id)) ? 'href="/Contracts/View?id=' . $contract->id . '"' : 'href="/Contracts"' ?> class=" btn btn-sm btn-danger">Annuleren</a>
        </div>
    </div>
