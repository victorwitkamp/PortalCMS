                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="kosten_totaal"
                                   class="form-control" <?= ($pageType === 'edit' && !empty($contract->kosten_totaal)) ? 'value="' . $contract->kosten_totaal . '"' : '' ?> disabled>
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="huur_dag" class="form-control">
                        ...
                        <option value="<?= Text::get('DAY_01') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_01')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_01') ?></option>
                        <option value="<?= Text::get('DAY_02') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_02')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_02') ?></option>
                        <option value="<?= Text::get('DAY_03') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_03')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_03') ?></option>
                        <option value="<?= Text::get('DAY_04') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_04')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_04') ?></option>
                        <option value="<?= Text::get('DAY_05') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_05')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_05') ?></option>
                        <option value="<?= Text::get('DAY_06') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_06')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
                            ><?= Text::get('DAY_06') ?></option>
                        <option value="<?= Text::get('DAY_07') ?>" <?= ($pageType === 'edit' && (strtoupper(Text::get('DAY_07')) === strtoupper($contract->huur_dag))) ? 'selected' : '' ?>
