    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="band_naam" class="form-control" value="<?= $contract->band_naam ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label class="col-form-label">Klantcode</label>
                        <input minlength="1" maxlength="2" type="number" name="bandcode" class="form-control" value="<?= $contract->bandcode ?>" required>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="kosten_ruimte" class="form-control" value="<?= $contract->kosten_ruimte ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_kast" class="form-control" value="<?= $contract->kosten_kast ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_totaal" class="form-control" value="<?= $contract->kosten_totaal ?>" disabled>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-euro-sign"></i></div></div>
                            <input type="number" name="kosten_borg" class="form-control" value="<?= $contract->kosten_borg ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="contract_ingangsdatum" class="form-control" value="<?= $contract->contract_ingangsdatum ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fa fa-calendar"></i></div></div>
                            <input type="date" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="contract_einddatum" class="form-control" value="<?= $contract->contract_einddatum ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fa fa-calendar"></i></div></div>
                            <input type="date" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="contract_datum" class="form-control" value="<?= $contract->contract_datum ?>">
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="bandleider_naam" class="form-control" value="<?= $contract->bandleider_naam ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="bandleider_adres" class="form-control" placeholder="Voorbeeldadres 123" value="<?= $contract->bandleider_adres ?>">
                    </div>
                    <div class="col-md-2">
                        <label class="col-form-label">Postcode</label>
                        <input type="text" name="bandleider_postcode" class="form-control" maxlength="6" placeholder="1234AB" value="<?= $contract->bandleider_postcode ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="col-form-label">Woonplaats</label>
                        <input type="text" name="bandleider_woonplaats" class="form-control" placeholder="Barendrecht" value="<?= $contract->bandleider_woonplaats ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="tel" name="bandleider_telefoonnummer1" class="form-control" value="<?= $contract->bandleider_telefoonnummer1 ?>">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fas fa-phone"></i></div></div>
                            <input type="tel" name="bandleider_telefoonnummer2" class="form-control" value="<?= $contract->bandleider_telefoonnummer2 ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="bandleider_bsn" class="form-control" value="<?= $contract->bandleider_bsn ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <div class="input-group-append"><div class="input-group-text"><i class="fa fa-calendar"></i></div></div>
                            <input type="date" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="bandleider_geboortedatum" class="form-control" value="<?= $contract->bandleider_geboortedatum ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="huur_kast_nr" class="form-control" value="<?= $contract->huur_kast_nr ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="time" name="huur_start" class="form-control" value="<?= $contract->huur_start ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="time" name="huur_einde" class="form-control" value="<?= $contract->huur_einde ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input type="text" name="beuk_vertegenwoordiger" class="form-control" value="<?= $contract->beuk_vertegenwoordiger ?>">
                </div>
            </div>
        </div>
    </div>
