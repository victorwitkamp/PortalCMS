...
<?= $this->push('main-content') ?>
    ...
    <div class="container">
        ...
        <p>Zorg ervoor dat de bedragen voor de huur van de ruimte en van een eventuele kast reeds ingevuld zijn in het
            contract.</p>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <?php foreach (ContractMapper::get() as $row) : ?>
                        <input type="checkbox" name='contract_id[]'
                               value="<?= $row->id ?>"> <?= $row->bandcode . ': ' . $row->band_naam ?><br/>
                    <?php endforeach ?>
                </div>
            </div>
