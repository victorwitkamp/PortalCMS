...
<div class="container">
    <div class="row mt-5">
        ...
        <div class="col-sm-4">
            <a href="NewTemplate" class="btn btn-info float-right"><span class="fa fa-plus"></span> <?= Text::get('TITLE_NEW_MAIL_TEMPLATE') ?></a>
        </div>
    </div>
    <hr>
        ...
        <tbody>
            ...
            foreach (EmailTemplateMapper::get() as $template) {
                ?><tr>
                    <td>
                        <form method="post">
                            <a href="EditTemplate?id=<?= $template['id'] ?>" title="Gegevens wijzigen" class="btn btn-warning btn-sm">
