        ...
        <form method="post" validate=true>
            <div class="form-group form-group-sm row">
                <div class="col-sm-12">
                    ...
                    <input type="text" name="title" value="<?= $event->title ?>" class="form-control input-sm"
            ...
            <div class="form-group form-group-sm row">
                <div class="col-sm-6">
                    ...
                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                        <input type="text" name="start_event" value="<?= $event->start_event ?>"
                               class="form-control input-sm datetimepicker-input" data-target="#datetimepicker1"
                               required>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                        <input type="text" name="end_event" value="<?= $event->end_event ?>"
                               class="form-control input-sm  datetimepicker-input" data-target="#datetimepicker2"
                               required>
            ...
            <div class="form-group form-group-sm row">
                ...
                <button type="submit" name="updateEvent" class="btn btn-sm btn-primary"><?= Text::get('LABEL_SUBMIT') ?>
                    <i class="far fa-save"></i></button>
                <a href="/Events" class="btn btn-sm btn-danger"><?= Text::get('LABEL_CANCEL') ?> <i
