...
<?= $this->push('body') ?>
    ...
    <div class="form-group form-check">
        <input type="checkbox" id="rememberMe" name="set_remember_me_cookie" class="form-check-input"><label
                class="form-check-label" for="rememberMe"><?= Text::get('LABEL_REMEMBER_ME') ?></label>
    </div>
    <hr/>
