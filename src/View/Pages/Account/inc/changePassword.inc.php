    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="password" minlength="8" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$"
                   ...
                   name="newpassword" id="newPassword" class="form-control" autocomplete="new-password" required/>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="password" name="newconfirmpassword" id="newConfirmPassword" class="form-control"
                   data-match="wachtwoord" data-match-field="#newPassword" autocomplete="new-password" required/>
        </div>
    </div>
