        ...
        <div class="col-md-8">
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input type="text" name="jaarlidmaatschap" class="form-control" value="<?php
                    if ($pageType === 'edit') {
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="telefoon_vast" value="<?php
                    if ($pageType === 'edit') {
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="emailadres" value="<?php
                        if ($pageType === 'edit') {
                            echo $row->emailadres;
