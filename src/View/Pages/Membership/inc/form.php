...
<form method="post" <?php if ($edit) {
        ...
        <div class="col-md-8">
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    <input type="text" name="jaarlidmaatschap" class="form-control" value="<?php if ($edit) {
    echo $row->jaarlidmaatschap;
} ?>" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                        ...
                        <input type="text" name="geboortedatum" value="<?php if ($edit) {
    echo $row->geboortedatum;
            ...
            <div class="form-group row">
                <div class="col-md-9">
                    ...
                    <input type="text" name="adres" value="<?php if ($edit) {
    echo $row->adres;
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="huisnummer" value="<?php if ($edit) {
    echo $row->huisnummer;
} ?>" class="form-control" maxlength="6" placeholder="123" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-5">
                    ...
                    <input type="text" name="postcode" value="<?php if ($edit) {
    echo $row->postcode;
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" name="woonplaats" value="<?php if ($edit) {
    echo $row->woonplaats;
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="telefoon_vast" value="<?php if ($edit) {
    echo $row->telefoon_vast;
} ?>" class="form-control" autocomplete="tel" required>
                </div>
                <div class="col-md-6">
                    <label class="col-form-label">Telefoon mobiel</label>
                    <input type="text" name="telefoon_mobiel" value="<?php if ($edit) {
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="emailadres" value="<?php if ($edit) {
    echo $row->emailadres;
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                        ...
                        <input type="text" name="ingangsdatum" value="<?php if ($edit) {
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="geslacht" class="form-control" required>
                    <option></option>
                    <option value="Man" <?php if ($edit && $row->geslacht === 'Man') {
    echo 'selected';
} ?>>Man</option>
                    <option value="Vrouw" <?php if ($edit && $row->geslacht === 'Vrouw') {
    echo 'selected';
} ?>>Vrouw</option>
                    <option value="nvt" <?php if ($edit && $row->geslacht === 'nvt') {
    echo 'selected';
} ?>>N.v.t.</option>
                </select>
                ...
                <select name="nieuwsbrief" class="form-control" required>
                    <option></option>
                    <option value="1" <?php if ($edit && $row->nieuwsbrief === 1) {
    echo 'selected';
} ?>>Ja</option>
                    <option value="0" <?php if ($edit && $row->nieuwsbrief === 0) {
    echo 'selected';
} ?>>Nee</option>
                </select>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <select name="vrijwilliger" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilliger === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilliger === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select name="vrijwilligeroptie1" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilligeroptie1 === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilligeroptie1 === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie2" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilligeroptie2 === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilligeroptie2 === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie3" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilligeroptie3 === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilligeroptie3 === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie4" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilligeroptie4 === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilligeroptie4 === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie5" class="form-control" required>
                        <option></option>
                        <option value="1" <?php if ($edit && $row->vrijwilligeroptie5 === 1) {
    echo 'selected';
} ?>>Ja</option>
                        <option value="0" <?php if ($edit && $row->vrijwilligeroptie5 === 0) {
    echo 'selected';
} ?>>Nee</option>
                    </select>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <select name="betalingswijze" class="form-control" required>
                <option></option>
                <option value="contant" <?php if ($edit && $row->betalingswijze === 'contant') {
    echo 'selected';
} ?>>Contant</option>
                <option value="pin" <?php if ($edit && $row->betalingswijze === 'pin') {
    echo 'selected';
} ?>>Pin</option>
                <option value="incasso" <?php if ($edit && $row->betalingswijze === 'incasso') {
    echo 'selected';
} ?>>Automatische incasso</option>
                <option value="gratisbestuur" <?php if ($edit && $row->betalingswijze === 'gratisbestuur') {
    echo 'selected';
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="text" name="iban" value="<?php if ($edit) {
    echo $row->iban;
} ?>" class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <select name="status" class="form-control">
                <option value="0" <?php if ($edit && $row->status === 0) {
    echo 'selected';
} ?>>0. Nieuw</option>
                <option value="1" <?php if ($edit && $row->status === 1) {
    echo 'selected';
} ?>>1. Incasso opdracht verzonden</option>
                <option value="1" <?php if ($edit && $row->status === 11) {
    echo 'selected';
} ?>>1.1 Niet verstuurd: rekeningnummer onjuist</option>
                <option value="2" <?php if ($edit && $row->status === 2) {
    echo 'selected';
} ?>>2. Betaling per incasso gelukt</option>
                <option value="2" <?php if ($edit && $row->status === 21) {
    echo 'selected';
} ?>>2.1 Incasso mislukt: rekeningnummer onjuist</option>
                <option value="3" <?php if ($edit && $row->status === 3) {
    echo 'selected';
} ?>>3</option>
                <option value="4" <?php if ($edit && $row->status === 4) {
    echo 'selected';
} ?>>4</option>
            </select>
        </div>
