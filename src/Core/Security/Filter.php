...
class Filter
{
     ...
     * "<script>var http = new XMLHttpRequest(); http.open('POST', 'example.com/my_account/delete.php');</script>"
    ...
    public static function XSSFilter(&$value)
    {
        if (is_string($value)) {
            ...
            // if argument is an array or an object, recursivly filters its content
            /**
