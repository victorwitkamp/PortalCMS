...
class LoginController extends Controller
{
    ...
    public static function loginSubmit(): bool
    {
        ...
        if (!empty($username) && !empty($password)) {
            if (LoginService::loginWithPassword($username, $password, $rememberMe)) {
    ...
    public static function loginWithCookie($cookie = null): bool
    {
        if (LoginService::loginWithCookie((string)$cookie)) {
            return true;
        }
