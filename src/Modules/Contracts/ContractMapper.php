...
class ContractMapper
{
    ...
    public static function new(Contract $contract): bool
    {
        ...
        $stmt->execute([
            $contract->accountManager, $contract->name, $contract->code, $contract->contractContact->name, $contract->contractContact->address, $contract->contractContact->zipCode, $contract->contractContact->city, $contract->contractContact->dateOfBirth, $contract->contractContact->phonePrimary, $contract->contractContact->phoneSecodary, $contract->contractContact->emailAddress, $contract->contractContact->citizenServiceNumber, $contract->rehearsalRoomNumber, $contract->day, $contract->startTime, $contract->endTime, $contract->storageNumber, $contract->rehearsalRoomMonthlyCost, $contract->storageMonthlyCost, $contract->totalMonthlyCost, $contract->bailCost, $contract->startDate, $contract->endDate, $contract->contractDate
        ]);
