...
<div class="mb-3 row">
    ...
    <div class="col-8">
        <input type="text" name="site_name" value="<?= ($settings['site_name'] ?? null) ?>" class="form-control">
    </div>

    <label class="col-4 col-form-label"><?= Text::get('LABEL_SITE_DESC') ?></label>
    <div class="col-8">
        <input type="text" name="site_description" value="<?= ($settings['site_description'] ?? null) ?>"
               class="form-control">
    </div>
    ...
    <div class="col-8">
        <div class="input-group">
            <select name="site_description_type" class="form-control">
                <option value="1" <?= (($settings['site_description_type'] ?? null) === '1') ? 'selected' : '' ?>>
                    <label class="form-check-label">1. Site description text</label>
                </option>
                <option value="2" <?= (($settings['site_description_type'] ?? null) === '2') ? 'selected' : '' ?>>
                    <label class="form-check-label">2. Random joke</label>
                </option>
                <option value="3" <?= (($settings['site_description_type'] ?? null) === '3') ? 'selected' : '' ?>>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="site_theme">
                <?php $SiteTheme = ($settings['site_theme'] ?? null); ?>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="site_layout">
                <?php $SiteLayout = ($settings['site_layout'] ?? null); ?>
    ...
    <div class="col-8">
        <input type="text" name="site_url" value="<?= ($settings['site_url'] ?? null) ?>" class="form-control">
    </div>

    <label class="col-4 col-form-label"><?= Text::get('LABEL_SITE_LOGO_URL') ?></label>
    <div class="col-8">
        <input type="text" name="site_logo" value="<?= ($settings['site_logo'] ?? null) ?>" class="form-control">
    </div>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="WidgetComingEvents">
                <?php $WidgetComingEvents = ($settings['WidgetComingEvents'] ?? null); ?>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="WidgetDebug">
                <?php $WidgetDebug = ($settings['WidgetDebug'] ?? null); ?>
...
<div class="mb-3 row">
    ...
    <div class="col-8">
        <input type="text" name="MailServer" value="<?= ($settings['MailServer'] ?? null) ?>" class="form-control">
    </div>
    <label class="col-4 col-form-label">SMTP server port</label>
    <div class="col-8">
        <input type="text" name="MailServerPort" value="<?= ($settings['MailServerPort'] ?? null) ?>" class="form-control">
    </div>
    <label class="col-4 col-form-label">SMTP encryption</label>
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="MailServerSecure">
                <?php $MailServerSecure = ($settings['MailServerSecure'] ?? null); ?>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="MailServerAuth">
                <?php $MailServerAuth = ($settings['MailServerAuth'] ?? null); ?>
    ...
    <div class="col-8">
        <input type="text" name="MailServerUsername" value="<?= ($settings['MailServerUsername'] ?? null) ?>"
               class="form-control">
    </div>
    <label class="col-4 col-form-label">SMTP password</label>
    <div class="col-8">
        <input type="password" name="MailServerPassword" value="<?= ($settings['MailServerPassword'] ?? null) ?>"
               class="form-control">
    </div>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="MailServerDebug">
                <?php $MailServerDebug = ($settings['MailServerDebug'] ?? null); ?>
    ...
    <div class="col-8">
        <input type="text" name="MailFromName" value="<?= ($settings['MailFromName'] ?? null) ?>" class="form-control">
    </div>

    <label class="col-4 col-form-label">MailFromEmail</label>
    <div class="col-8">
        <input type="text" name="MailFromEmail" value="<?= ($settings['MailFromEmail'] ?? null) ?>" class="form-control">
    </div>
    ...
    <div class="col-8">
        <div class="input-group">
            <select class="form-control" name="MailIsHTML">
                <?php $MailIsHTML = ($settings['MailIsHTML'] ?? null); ?>
