...
?>
<?= $this->layout('View::Layout/ApplicationLayout', [ 'title' => $this->e($pageName) ]) ?>
    ...
    <div class="container">
        ...
        <form method="post" action="/Events/Edit">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="datetime-local" id="eventStart" name="start_event"
                           value="<?= $event->start_event->format('Y-m-d\TH:i') ?>" class="form-control"
                           required>
                </div>
                <div class="col-sm-6">
                    ...
                    <input type="datetime-local" id="eventEnd" name="end_event"
                           value="<?= $event->end_event->format('Y-m-d\TH:i') ?>" class="form-control"
                           required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <button type="submit" class="btn btn-primary"><?= Text::get('LABEL_SUBMIT') ?> <i
