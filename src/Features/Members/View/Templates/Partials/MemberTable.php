...
<form method="post">
    <div class="row">
        <div class="col-auto">
            <input class="btn btn-danger" type="submit" formaction="/Membership/Delete" value="deleteMembersById"/>
        </div>
    </div>
    <div class="row align-items-center">
        ...
        <div class="col-auto">
            <input class="btn btn-info" type="submit" formaction="/Membership/Status" value="setPaymentStatusById"/>
        </div>
    </div>
