...
$edit = ($pageType === 'edit');
?>
<form method="post" action="<?= $edit ? '/Membership/Edit' : '/Membership/New' ?>"<?= $edit ? ' validate=true' : '' ?>>
        ...
        <div class="col-md-8">
            ...
            <div class="mb-3 row">
                <div class="col-md-5">
                    ...
                    <input type="text" name="postcode" value="<?= ($edit) ? $member->postcode : '' ?>"
                           class="form-control" minlength="6" maxlength="6" placeholder="1234AB"
                           autocomplete="postal-code">
                </div>
                <div class="col-md-7">
                    <label class="col-form-label">Woonplaats</label>
                    <input type="text" name="woonplaats" value="<?= ($edit) ? $member->woonplaats : '' ?>"
            ...
            <div class="mb-3 row">
                <div class="col-md-6">
                    ...
                    <input type="tel" name="telefoon_vast"
                           value="<?= ($edit) ? $member->telefoon_vast : '' ?>" class="form-control"
                           autocomplete="tel">
                </div>
                <div class="col-md-6">
                    <label class="col-form-label">Telefoon mobiel</label>
                    <input type="tel" name="telefoon_mobiel"
                           value="<?= ($edit) ? $member->telefoon_mobiel : '' ?>" class="form-control"
                           autocomplete="tel">
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="emailadres"
                               value="<?= ($edit) ? $member->emailadres : '' ?>" class="form-control"
                               autocomplete="email">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date"
                               pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
                               name="ingangsdatum"
                               value="<?= ($edit && !empty($member->ingangsdatum)) ? date('Y-m-d', strtotime($member->ingangsdatum)) : '' ?>"
                               class="form-control">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <select name="geslacht" class="form-control">
                    ...
                    <option value="Vrouw" <?= ($edit && $member->geslacht === 'Vrouw') ? 'selected' : '' ?>>Vrouw
                    </option>
                ...
                <select name="nieuwsbrief" class="form-control">
                    <option></option>
                    <option value="1" <?= ($edit && $member->nieuwsbrief === true) ? 'selected' : '' ?>>Ja
                    </option>
                    <option value="0" <?= ($edit && $member->nieuwsbrief === false) ? 'selected' : '' ?>>Nee
                    </option>
                </select>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <select name="vrijwilliger" class="form-control">
                        <option></option>
                        <option value="1" <?= ($edit && $member->vrijwilliger === true) ? 'selected' : '' ?>>
                            Ja
                        </option>
                        <option value="0" <?= ($edit && $member->vrijwilliger === false) ? 'selected' : '' ?>>
                            Nee
                        </option>
                    </select>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select name="vrijwilligeroptie1" class="form-control">
                        <option></option>
                        <option value="1" <?= ($edit && $member->vrijwilligeroptie1 === true) ? 'selected' : '' ?>>
                            Ja
                        </option>
                        <option value="0" <?= ($edit && $member->vrijwilligeroptie1 === false) ? 'selected' : '' ?>>
                            Nee
                        </option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie2" class="form-control">
                        <option></option>
                        <option value="1" <?php
                        if ($edit && $member->vrijwilligeroptie2 === true) {
                            echo 'selected';
                        } ?>>Ja
                        </option>
                        <option value="0" <?php
                        if ($edit && $member->vrijwilligeroptie2 === false) {
                            echo 'selected';
                        } ?>>Nee
                        </option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie3" class="form-control">
                        <option></option>
                        <option value="1" <?php
                        if ($edit && $member->vrijwilligeroptie3 === true) {
                            echo 'selected';
                        } ?>>Ja
                        </option>
                        <option value="0" <?php
                        if ($edit && $member->vrijwilligeroptie3 === false) {
                            echo 'selected';
                        } ?>>Nee
                        </option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie4" class="form-control">
                        <option></option>
                        <option value="1" <?php
                        if ($edit && $member->vrijwilligeroptie4 === true) {
                            echo 'selected';
                        } ?>>Ja
                        </option>
                        <option value="0" <?php
                        if ($edit && $member->vrijwilligeroptie4 === false) {
                            echo 'selected';
                        } ?>>Nee
                        </option>
                    </select>
                    ...
                    <select name="vrijwilligeroptie5" class="form-control">
                        <option></option>
                        <option value="1" <?php
                        if ($edit && $member->vrijwilligeroptie5 === true) {
                            echo 'selected';
                        } ?>>Ja
                        </option>
                        <option value="0" <?php
                        if ($edit && $member->vrijwilligeroptie5 === false) {
                            echo 'selected';
                        } ?>>Nee
                        </option>
                    </select>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <select name="betalingswijze" class="form-control">
                <option></option>
                <option value="contant" <?= ($edit && $member->betalingswijze === 'contant') ? 'selected' : '' ?>>
                    Contant
                </option>
                <option value="pin" <?= ($edit && $member->betalingswijze === 'pin') ? 'selected' : '' ?>>
                    Pin
                </option>
                <option value="incasso" <?= ($edit && $member->betalingswijze === 'incasso') ? 'selected' : '' ?>>
                    Automatische incasso
                </option>
                <option value="gratisbestuur" <?= ($edit && $member->betalingswijze === 'gratisbestuur') ? 'selected' : '' ?>>
                    Gratis (bestuur)
                </option>
            </select>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="text" name="iban" value="<?= ($edit) ? $member->iban : '' ?>"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="text" name="machtigingskenmerk" value="<?= ($edit) ? $member->machtigingskenmerk : '' ?>"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <select name="status" class="form-control">
                <option value="0" <?= ($edit && $member->status === 0) ? 'selected' : '' ?>>0. Nieuw
                </option>
                <option value="1" <?= ($edit && $member->status === 1) ? 'selected' : '' ?>>1. Incasso
                    opdracht verzonden
                </option>
                <option value="1" <?= ($edit && $member->status === 11) ? 'selected' : '' ?>>1.1 Niet
                    verstuurd: rekeningnummer onjuist
                </option>
                <option value="2" <?= ($edit && $member->status === 2) ? 'selected' : '' ?>>2. Betaling
                    per incasso gelukt
                </option>
                <option value="2" <?= ($edit && $member->status === 21) ? 'selected' : '' ?>>2.1 Incasso
                    mislukt: rekeningnummer onjuist
                </option>
                <option value="3" <?= ($edit && $member->status === 3) ? 'selected' : '' ?>>3</option>
                <option value="4" <?= ($edit && $member->status === 4) ? 'selected' : '' ?>>4</option>
            </select>
        </div>
    </div>
