...
?>
<form method="post" action="<?= $pageType === 'edit' ? '/Contracts/Edit' : '/Contracts/New' ?>">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date"
                                   ...
                                   class="form-control" <?= ($pageType === 'edit' && !empty($contract->contract_ingangsdatum)) ? 'value="' . $contract->contract_ingangsdatum->format('Y-m-d') . '"' : '' ?>>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date"
                                   ...
                                   class="form-control" <?= ($pageType === 'edit' && !empty($contract->contract_einddatum)) ? 'value="' . $contract->contract_einddatum->format('Y-m-d') . '"' : '' ?>>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date"
                                   pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
                                   name="contract_datum"
                                   class="form-control" <?= ($pageType === 'edit' && !empty($contract->contract_datum)) ? 'value="' . $contract->contract_datum->format('Y-m-d') . '"' : '' ?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="time" name="huur_start"
                               class="form-control" <?= ($pageType === 'edit' && !empty($contract->huur_start)) ? 'value="' . $contract->huur_start->format('H:i') . '"' : '' ?>
                        ">
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="time" name="huur_einde"
                               class="form-control"<?= ($pageType === 'edit' && !empty($contract->huur_einde)) ? 'value="' . $contract->huur_einde->format('H:i') . '"' : '' ?>
                        ">
                    </div>
                </div>
            </div>
