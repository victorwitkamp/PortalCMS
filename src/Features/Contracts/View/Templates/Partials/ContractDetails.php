...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <table class="table table-striped table-condensed">
            ...
            <tr>
                <th>Ingangsdatum</th>
                <td><?= $contract->contract_ingangsdatum?->format('Y-m-d') ?></td>
            </tr>
            <tr>
                <th>Einddatum</th>
                <td><?= $contract->contract_einddatum?->format('Y-m-d') ?></td>
            </tr>
            <tr>
                <th>Contractdatum</th>
                <td><?= $contract->contract_datum?->format('Y-m-d') ?></td>
            </tr>
            </tbody>
        </table>
        <h3>Oefenruimte</h3>
        <table class="table table-striped table-condensed">
            ...
            <tr>
                <th>huur_start</th>
                <td><?= $contract->huur_start?->format('H:i') ?></td>
            </tr>
            <tr>
                <th>huur_eind</th>
                <td><?= $contract->huur_einde?->format('H:i') ?></td>
            </tr>
            <tr>
                <th>huur_kast_nr</th>
