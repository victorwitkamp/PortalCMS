...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        ...
        <a class="dropdown-item" href="/mailscheduler/"><?php echo Text::get('TITLE_MAIL_SCHEDULER'); ?></a>
        <a class="dropdown-item" href="/mailscheduler/templates"><?php echo Text::get('TITLE_MAIL_TEMPLATES'); ?></a>
        <div class="dropdown-divider"></div>
