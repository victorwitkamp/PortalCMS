...
use App\Core\Security\Authorization\RolePermissionMapper;
...
if ($Role) { ?>
    ...
    <table class="table table-striped table-condensed">
        ...
        <tr>
            ...
            <td>
                <?php
                $ActivePerissions = RolePermissionMapper::getRolePermissions((int)$this->request->get('id'));
                if (!empty($ActivePerissions)) { ?>
                    ...
                    <?php foreach ($ActivePerissions as $Permission) { ?>
                        <tr>
                            ...
                            <td>
                                <form method="post">
                                    <input type="hidden" name="role_id" value="<?= (int)$this->request->get('id') ?>">
...
if ($Role) {
    ...
    <?php
    $selectablePermissions = RolePermissionMapper::getRoleSelectablePermissions((int)$this->request->get('id'));
