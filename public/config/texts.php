...
return array(
    ...
    "TITLE_NEW_MAIL_TEMPLATE" => "NIEUW TEMPLATE",
    "TITLE_EDIT_MAIL_TEMPLATE" => "TEMPLATE BEWERKEN",
    "MAIL_ATTACHMENT_UPLOAD_SUCCESSFUL" => "Bijlage toegevoegd.",

    // MAILDETAILS
    "TITLE_MAIL_DETAILS" => "Details voor Mail ID: ",
    "LABEL_MAILDETAILS_ID" => "MAILDETAILS_ID",
    "LABEL_MAILDETAILS_SENDER" => "MAILDETAILS_SENDER",
    "LABEL_MAILDETAILS_RECIPIENT_TO" => "MAILDETAILS_RECIPIENT_TO",
    "LABEL_MAILDETAILS_RECIPIENT_CC" => "MAILDETAILS_RECIPIENT_CC",
    "LABEL_MAILDETAILS_RECIPIENT_BCC" => "MAILDETAILS_RECIPIENT_BCC",
    "LABEL_MAILDETAILS_SUBJECT" => "MAILDETAILS_SUBJECT",
    "LABEL_MAILDETAILS_BODY" => "MAILDETAILS_BODY",
    "LABEL_MAILDETAILS_ATTACHMENT" => "MAILDETAILS_ATTACHMENT",
