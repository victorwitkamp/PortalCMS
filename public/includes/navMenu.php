...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="/mail/"><?= Text::get('TITLE_MAIL_SCHEDULER') ?></a>
        <a class="dropdown-item" href="/mail/history.php"><?= Text::get('TITLE_MAIL_HISTORY') ?></a>
        <a class="dropdown-item" href="/mail/templates/"><?= Text::get('TITLE_MAIL_TEMPLATES') ?></a>
    </div>
</li>
