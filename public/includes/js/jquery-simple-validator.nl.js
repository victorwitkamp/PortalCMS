! function t(e, a, r) {
    ...
    3: [function (t, e, a) {
        ...
        var r = t("./validations"),
            ...
            u = function (t) {
                var e = !0;
                if ($(t).attr("required") && (e = "checkbox" == $(t).attr("type") ? e ? o(t, "checked", r.validationFn.required, "You need to check this") : e : e ? o(t, "value", r.validationFn.required, "Dit is een vereist veld.") : e), "email" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.email, "Voer een geldig e-mailadres in.") : e), "url" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.url, "The url is invalid") : e), "mobile" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.mobile, "The mobile number is invalid") : e), $(t).attr("pattern") && (e = e ? o(t, "value", r.validationFn.pattern, "Please match the requested pattern") : e), $(t).attr("data-match-field") && (e = e ? o(t, "value", r.validationFn.match, "Het ingevoerde " + $(t).attr("data-match") + " komt niet overeen.") : e), "file" == $(t).attr("type")) {
