...
<form method="post" validate=true>
    <div class="form-group row">
        <label for="currentPassword" class="col-sm-4 col-form-label"><?php echo Text::get('LABEL_CURRENT_PASSWORD'); ?></label>
        <div class="col-sm-8">
            <input type="password" name="currentpassword" id="currentPassword" class="form-control" autocomplete="current-password" required/>
        </div>
    </div>
    <div class="form-group row">
        <label for="newPassword" class="col-sm-4 col-form-label"><?php echo Text::get('LABEL_NEW_PASSWORD'); ?></label>
        <div class="col-sm-8">
