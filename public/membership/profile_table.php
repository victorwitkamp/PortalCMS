...
<table class="table table-striped table-condensed">
    ...
    <tr>
        <th>Nieuwsbrief</th><td><?php if ($row['nieuwsbrief'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Vrijwilliger</th><td><?php if ($row['vrijwilliger'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Licht / geluid</th><td><?php if ($row['vrijwilligeroptie1'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Bar</th><td><?php if ($row['vrijwilligeroptie2'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Schoonmaken / klussen</th><td><?php if ($row['vrijwilligeroptie3'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Promotie / flyeren</th><td><?php if ($row['vrijwilligeroptie4'] === '1') {
    echo 'ja';
    ...
    <tr>
        <th>Organisatie evenementen</th><td><?php if ($row['vrijwilligeroptie5'] === '1') {
    echo 'ja';
