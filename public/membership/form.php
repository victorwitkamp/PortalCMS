<form method="post" <?php if ($pageType === 'edit') {
    echo 'validate=true';
} ?>>
...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="form-group row">
            <div class="col-md-4">
                ...
                <input type="text" name="jaarlidmaatschap" class="form-control" placeholder="" value="<?php if ($pageType === 'edit') {
        ...
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                    ...
                    <input type="text" name="geboortedatum" value="<?php if ($pageType === 'edit') {
    echo $row ['geboortedatum'];
        ...
        <div class="form-group row">
            <div class="col-md-9">
                ...
                <input type="text" name="adres" value="<?php if ($pageType === 'edit') {
    echo $row ['adres'];
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="huisnummer" value="<?php if ($pageType === 'edit') {
    echo $row ['huisnummer'];
        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <input type="text" name="postcode" value="<?php if ($pageType === 'edit') {
    echo $row ['postcode'];
            ...
            <div class="col-md-7">
                ...
                <input type="text" name="woonplaats" value="<?php if ($pageType === 'edit') {
    echo $row ['woonplaats'];
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="text" name="telefoon_vast" value="<?php if ($pageType === 'edit') {
    echo $row ['telefoon_vast'];
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="telefoon_mobiel" value="<?php if ($pageType === 'edit') {
        ...
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="emailadres" value="<?php if ($pageType === 'edit') {
    echo $row ['emailadres'];
        ...
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                    ...
                    <input type="text" name="ingangsdatum" value="<?php if ($pageType === 'edit') {
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <select name="geslacht" class="form-control" required>
                <option></option>
                <option value="Man" <?php if ($pageType === 'edit') {
    if ($row ['geslacht'] === 'Man') {
        echo 'selected';
    }
} ?>>Man</option>
                <option value="Vrouw" <?php if ($pageType === 'edit') {
    if ($row ['geslacht'] === 'Vrouw') {
        echo 'selected';
    }
}?>>Vrouw</option>
                <option value="nvt" <?php if ($pageType === 'edit') {
    if ($row ['geslacht'] === 'nvt') {
        echo 'selected';
    }
}?>>N.v.t.</option>
            ...
            <select name="nieuwsbrief" class="form-control" required>
                <option></option>
                <option value="1" <?php if ($pageType === 'edit') {
    if ($row ['nieuwsbrief'] === '1') {
        echo 'selected';
    }
}?>>Ja</option>
                <option value="0" <?php if ($pageType === 'edit') {
    if ($row ['nieuwsbrief'] === '0') {
        echo 'selected';
    }
}?>>Nee</option>
            </select>
...
<div class="row">
    <div class="col-md-12">
        ...
        <select name="betalingswijze" class="form-control" required>
            <option></option>
            <option value="contant" <?php if ($pageType === 'edit') {
    if ($row ['betalingswijze'] === 'contant') {
        echo 'selected';
    }
} ?>>Contant</option>
            <option value="pin" <?php if ($pageType === 'edit') {
    if ($row ['betalingswijze'] === 'pin') {
        echo 'selected';
    }
} ?>>Pin</option>
            <option value="incasso" <?php if ($pageType === 'edit') {
    if ($row ['betalingswijze'] === 'incasso') {
        echo 'selected';
    }
} ?>>Automatische incasso</option>
            <option value="gratisbestuur" <?php if ($pageType === 'edit') {
    if ($row ['betalingswijze'] === 'gratisbestuur') {
        echo 'selected';
    }
...
<div class="row">
    <div class="col-md-12">
        ...
        <input type="text" name="iban" value="<?php if ($pageType === 'edit') {
    echo $row ['iban'];
} ?>" class="form-control">
    </div>
</div>
...
<div class="row">
    ...
    if ($row ['status'] === '11') {
        echo 'selected';
            ...
            <option value="2" <?php if ($pageType === 'edit') {
    if ($row ['status'] === '2') {
        echo 'selected';
    }
    ...
    if ($row ['status'] === '21') {
        echo 'selected';
            ...
            <option value="3" <?php if ($pageType === 'edit') {
    if ($row ['status'] === '3') {
        echo 'selected';
    }
} ?>>3</option>
            <option value="4" <?php if ($pageType === 'edit') {
    if ($row ['status'] === '4') {
        echo 'selected';
    }
} ?>>4</option>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <input type="hidden" name="id" value="<?php if ($pageType === 'edit') {
    echo $row ['id'];
} ?>">

                <input type="submit" <?php if ($pageType === 'edit') {
