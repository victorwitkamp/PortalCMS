...
<div class="col-6">
    <table class="table table-striped table-condensed">
        ...
        <tr>
            <th>Gebruikersnaam</th><td><?php echo $row['user_name']; ?></td>
        </tr>
            <tr>
            <th>Session ID</th><td><?php echo $row['session_id']; ?></td>
        </tr>
        <tr>
            <th>E-mailadres</th><td><?php echo $row['user_email']; ?></td>
        </tr>
        <tr>
            <th>Account actief</th><td><?php echo $row['user_active']; ?></td>
        </tr>
        <tr>
            <th>Account verwijderd</th><td><?php echo $row['user_deleted']; ?></td>
        </tr>
        <tr>
            <th>Laatste aanmelding</th><td><?php echo $row['user_last_login_timestamp']; ?></td>
        </tr>
        <tr>
            <th>Mislukte aanmeldingen</th><td><?php echo $row['user_failed_logins']; ?></td>
        </tr>
        <tr>
            <th>Laatste mislukte aanmelding</th><td><?php echo $row['user_last_failed_login']; ?></td>
        </tr>
        <tr>
            <th>Facebook ID</th><td><?php echo $row['user_fbid']; ?></td>
        </tr>
        <tr>
